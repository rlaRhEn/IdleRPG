...
public class HudMobileLayoutAdapter : MonoBehaviour
{
    ...
    [SerializeField] private RectTransform topRightSettingsButton;
    ...
    void Start()
    {
        ...
        if (topRightSettingsButton != null) _baseTopRightPos = topRightSettingsButton.anchoredPosition;
    ...
    void ApplySafeArea()
    {
        ...
        if (topRightSettingsButton != null)
            topRightSettingsButton.anchoredPosition = _baseTopRightPos + new Vector2(-(rightInset + safePadding), -(topInset + safePadding));
